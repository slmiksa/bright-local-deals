    ...
    <div className="min-h-screen bg-background pb-28 max-w-[430px] mx-auto">
      ...
      <div className="px-5 pt-5">
        ...
        <div className="mt-5 flex gap-3">
          ...
          <a href={`https://wa.me/966${ad.phone.slice(1)}?text=${encodeURIComponent(`السلام عليكم، تواصلت معكم من خلال تطبيق لمحة للتسويق 🔖\nبخصوص إعلان: ${ad.shopName} - ${ad.offer}`)}`} target="_blank" rel="noopener noreferrer" className="touch-target w-14 h-14 flex items-center justify-center bg-[hsl(142_70%_45%)] text-primary-foreground rounded-2xl active:scale-[0.97] transition-transform shadow-card">
